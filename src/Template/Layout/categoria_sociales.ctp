        ...
        <div class="row">
            ...
            <div class="sector col-md-4">
                <div class="container-noticia"> 
                    ...
                    <div class="share" onclick="shareNew('<?=$this->Url->build(['controller' => 'Frontend', 'action' => 'ver_articulo', $sociales->slug], true)?>', '', '<?=$sociales->titulo?>')"><?php echo $this->Html->image("../assets/images/share2.png", ['class' => 'share_home_ncs']) ?></div>
