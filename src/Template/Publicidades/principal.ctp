...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Publicidades
            <a href="<?=$this->Url->build(['action' => 'principal_add'], true)?>" class="btn btn-success pull-right"><span class="fa fa-plus"></span>&nbsp;Nueva publicidad</a>
        </h2>
    </div>
    <!-- /.col-lg-12 -->
</div>
...
<!--                <td><?= $publicidad->has('imagen') ? $this->Html->link($publicidad->imagen->id, ['controller' => 'Imagenes', 'action' => 'view', $publicidad->imagen->id]) : '' ?></td>
                ...
                <td class="actions">
                    ...
                    <?= $this->Html->link('<span class="fa fa-pencil"></span>', ['action' => 'principal_edit', $publicidad->id], ['escape' => false, 'title' => __('Editar'), 'class' => 'btn btn-primary btn-xs']) ?>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <?= $this->Form->postLink('Borrar', ['action' => 'principal_delete', $publicidad->id], ['class' => 'btn btn-primary']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
