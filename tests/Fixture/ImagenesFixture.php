...
class ImagenesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'comentario' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'creado' => '2019-06-22 21:51:08',
                'modificado' => '2019-06-22 21:51:08'
            ],
        ];
        parent::init();
    }
